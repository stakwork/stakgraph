  ...
  async function verifyExpectation(action) {
    ...
    switch (action.expectation) {
      ...
      case "toContainText":
        ...
        if (!textElement || !((_a = textElement.textContent) == null ? void 0 : _a.includes(textValue))) {
          throw new Error(
      ...
      case "toHaveText":
        ...
        if (!exactTextElement || ((_b = exactTextElement.textContent) == null ? void 0 : _b.trim()) !== exactTextValue) {
          throw new Error(
