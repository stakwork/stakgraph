...
const DEFAULT_DESCRIPTIONS: Record<ToolName, string> = {
  ...
  final_answer: `Provide the final answer to the user. YOU CAN CALL THIS TOOL AT THE END OF YOUR EXPLORATION. Put your ENTIRE response inside the 'answer' parameter as a well-formatted string.`,
    ...
    final_answer: tool({
      ...
      execute: async (body: { answer?: string }) => {
        ...
        if (!body.answer || body.answer.trim() === "") {
          return "__NEEDS_ANSWER__: Please provide your complete answer as text in your next response.";
        }
        return body.answer;
      },
    }),
