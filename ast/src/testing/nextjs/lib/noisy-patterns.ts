...
// @ast edge: Contains <- File "noisy-patterns.ts" "src/testing/nextjs/lib/noisy-patterns.ts"
// @ast node: Function "onSuccess"
// @ast edge: Contains <- File "noisy-patterns.ts" "src/testing/nextjs/lib/noisy-patterns.ts"
// @ast edge: NestedIn -> Function "createApiHandlers" "src/testing/nextjs/lib/noisy-patterns.ts"
...
// @ast edge: Contains <- File "noisy-patterns.ts" "src/testing/nextjs/lib/noisy-patterns.ts"
// @ast edge: NestedIn -> Var "deepConfig" "src/testing/nextjs/lib/noisy-patterns.ts"
...
// @ast edge: Contains <- File "noisy-patterns.ts" "src/testing/nextjs/lib/noisy-patterns.ts"
// @ast absent: Function "text" "src/testing/nextjs/lib/noisy-patterns.ts"
