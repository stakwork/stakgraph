...
// @ast edge: Contains <- File "unit.noisy-patterns.test.ts" "app/test/unit.noisy-patterns.test.ts"
...
// @ast edge: Contains <- File "unit.noisy-patterns.test.ts" "app/test/unit.noisy-patterns.test.ts"
// @ast absent: Function "helperInsideDescribe" "app/test/unit.noisy-patterns.test.ts"
