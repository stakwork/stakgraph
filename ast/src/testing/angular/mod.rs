...
import {{ AppComponent }} from './app/app.component';"#
    ...
    // Check for service method calls through Request nodes (Angular dependency injection pattern)
    ...
    let add_person_page_nodes = graph.find_nodes_by_file_ends_with(
        NodeType::Page,
        "src/app/add-person/add-person.component.html",
    );
    assert_eq!(
    ...
    assert_eq!(renders_edges_count, 7, "Expected 7 renders edges");
