// @ast node: IntegrationTest "integration_test_create_and_fetch_person"
// @ast edge: Calls -> Function "new_person" "routes.cpp"
// @ast edge: Calls -> Function "get_person_by_id" "routes.cpp"
// @ast node: IntegrationTest "integration_test_invalid_json"
// @ast edge: Calls -> Function "new_person" "routes.cpp"
// @ast node: IntegrationTest "integration_test_not_found"
// @ast edge: Calls -> Function "get_person_by_id" "routes.cpp"
