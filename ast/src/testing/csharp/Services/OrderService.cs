// @ast node: Class "IOrderService"
// @ast node: Class "OrderService"
// @ast edge: Operand -> Function "CreateAsync" "OrderService.cs"
// @ast edge: Operand -> Function "CancelAsync" "OrderService.cs"
// @ast node: Trait "IOrderService"
// @ast edge: ParentOf -> Class "OrderService" "OrderService.cs"
// @ast node: Function "AddItemAsync"
// @ast edge: Calls -> Function "GetByIdWithItemsAsync" "Repositories.cs"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "AddItemAsync"
// @ast node: Function "CancelAsync"
// @ast edge: Calls -> Function "IncrementStock" "Product.cs"
// @ast edge: Calls -> Function "GetByIdWithItemsAsync" "Repositories.cs"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "CancelAsync"
// @ast node: Function "ConfirmAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "ConfirmAsync"
// @ast node: Function "CreateAsync"
// @ast edge: Calls -> Function "CalculateTotals" "Order.cs"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast edge: Calls -> Function "AddAsync" "Repositories.cs"
// @ast node: Function "CreateAsync"
// @ast node: Function "GenerateOrderNumber"
...
// @ast edge: Calls -> Function "GetByUserIdAsync" "Repositories.cs"
// @ast node: Function "GetByUserIdAsync"
// @ast node: Function "GetOrderItemsAsync"
// @ast edge: Calls -> Function "GetByIdWithItemsAsync" "Repositories.cs"
// @ast node: Function "GetOrderItemsAsync"
// @ast node: Function "GetTrackingInfoAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast node: Function "GetTrackingInfoAsync"
// @ast node: Function "MarkRefundedAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "MarkRefundedAsync"
// @ast node: Function "OrderService"
// @ast node: Function "RemoveItemAsync"
// @ast edge: Calls -> Function "GetByIdWithItemsAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "RemoveItemAsync"
// @ast node: Function "UpdateStatusAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "UpdateStatusAsync"
// @ast node: Var "_logger"
// @ast node: Var "_mapper"
// @ast node: Var "_orderRepository"
// @ast node: Var "_personRepository"
// @ast node: Var "_productRepository"
// @ast node: Import "import-imports-srctestingcsharpservicesorderservicecs-61"
