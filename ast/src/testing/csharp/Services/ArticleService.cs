// @ast node: Class "ArticleService"
// @ast edge: Operand -> Function "CreateAsync" "ArticleService.cs"
// @ast node: Class "IArticleService"
// @ast edge: ParentOf -> Class "ArticleService" "ArticleService.cs"
// @ast node: Trait "IArticleService"
// @ast node: Function "AddCommentAsync"
// @ast edge: Calls -> Function "AddCommentAsync" "Repositories.cs"
// @ast node: Function "AddCommentAsync"
// @ast node: Function "ArticleService"
...
// @ast edge: Calls -> Function "DeleteAsync" "Repositories.cs"
// @ast node: Function "DeleteAsync"
// @ast node: Function "GetAllPagedAsync"
// @ast node: Function "GetAllPagedAsync"
// @ast node: Function "GetByAuthorAsync"
// @ast edge: Calls -> Function "GetByAuthorIdAsync" "Repositories.cs"
// @ast node: Function "GetByAuthorAsync"
// @ast node: Function "GetByIdAsync"
// @ast node: Function "GetByIdAsync"
// @ast node: Function "GetCommentsAsync"
// @ast edge: Calls -> Function "GetCommentsAsync" "Repositories.cs"
// @ast node: Function "GetCommentsAsync"
// @ast node: Function "GetFeaturedAsync"
// @ast edge: Calls -> Function "GetFeaturedAsync" "Repositories.cs"
// @ast node: Function "GetFeaturedAsync"
// @ast node: Function "LikeAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "LikeAsync"
// @ast node: Function "PublishAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "PublishAsync"
// @ast node: Function "UnpublishAsync"
// @ast edge: Calls -> Function "GetByIdAsync" "Repositories.cs"
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "UnpublishAsync"
...
// @ast edge: Calls -> Function "UpdateAsync" "Repositories.cs"
// @ast node: Function "UpdateAsync"
// @ast node: Var "_articleRepository"
// @ast node: Var "_logger"
// @ast node: Var "_mapper"
// @ast node: Import "import-imports-srctestingcsharpservicesarticleservicecs-49"
