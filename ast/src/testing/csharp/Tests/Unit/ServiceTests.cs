// @ast node: Class "ArticleModelTests"
// @ast node: Class "ArticleServiceTests"
// @ast node: Class "OrderServiceTests"
// @ast node: Class "PersonModelTests"
// @ast node: Class "PersonServiceTests"
// @ast node: Class "ProductModelTests"
// @ast node: UnitTest "ArticleServiceTests"
// @ast node: UnitTest "CalculateAge_ReturnsCorrectAge"
// @ast node: UnitTest "CancelAsync_RestoresInventory"
// @ast node: UnitTest "ConfirmAsync_SetsConfirmedStatus"
// @ast node: UnitTest "CreateAsync_CalculatesTotals"
// @ast node: UnitTest "CreateAsync_CreatesNewPerson"
// @ast node: UnitTest "CreateAsync_GeneratesSlug"
// @ast node: UnitTest "Deactivate_SetsIsActiveFalse"
// @ast node: UnitTest "DecrementStock_ReducesQuantity"
// @ast node: UnitTest "DecrementStock_ThrowsWhenInsufficientStock"
// @ast node: UnitTest "DeleteAsync_WhenPersonDoesNotExist_ReturnsFalse"
// @ast node: UnitTest "DeleteAsync_WhenPersonExists_ReturnsTrue"
// @ast node: UnitTest "DiscountPercentage_CalculatesCorrectly"
// @ast node: UnitTest "FullName_ConcatenatesFirstAndLastName"
// @ast node: UnitTest "GenerateSlug_CreatesValidSlug"
// @ast node: UnitTest "GetAllAsync_ReturnsPagedResults"
// @ast node: UnitTest "GetByIdAsync_IncrementsViewCount"
// @ast node: UnitTest "GetByIdAsync_WhenPersonDoesNotExist_ReturnsNull"
// @ast node: UnitTest "GetByIdAsync_WhenPersonExists_ReturnsPerson"
// @ast node: UnitTest "GetFeaturedAsync_ReturnsFeaturedArticles"
// @ast node: UnitTest "IncrementViewCount_IncreasesCount"
// @ast node: UnitTest "IsInStock_WhenQuantityGreaterThanZero_ReturnsTrue"
// @ast node: UnitTest "IsInStock_WhenQuantityIsZero_ReturnsFalse"
// @ast node: UnitTest "IsLowStock_WhenBelowThreshold_ReturnsTrue"
// @ast node: UnitTest "OrderServiceTests"
// @ast node: UnitTest "PersonServiceTests"
// @ast node: UnitTest "PublishAsync_SetsPublishedStatus"
// @ast node: UnitTest "Publish_SetsCorrectState"
// @ast node: UnitTest "SearchAsync_ReturnsMatchingPersons"
// @ast node: UnitTest "Unpublish_SetsCorrectState"
// @ast node: UnitTest "UpdateAsync_WhenPersonExists_UpdatesPerson"
// @ast node: Var "_articleRepositoryMock"
// @ast node: Var "_articleRepositoryMock"
// @ast node: Var "_fileStorageMock"
// @ast node: Var "_loggerMock"
// @ast node: Var "_loggerMock"
// @ast node: Var "_loggerMock"
// @ast node: Var "_mapperMock"
// @ast node: Var "_mapperMock"
// @ast node: Var "_mapperMock"
// @ast node: Var "_orderRepositoryMock"
// @ast node: Var "_personRepositoryMock"
// @ast node: Var "_personRepositoryMock"
// @ast node: Var "_productRepositoryMock"
// @ast node: Var "_service"
// @ast node: Var "_service"
// @ast node: Var "_service"
// @ast node: Import "import-imports-srctestingcsharptestsunitservicetestscs-54"
using Xunit;
using Moq;
