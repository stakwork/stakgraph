...
async fn test_rust_coverage() -> Result<()> {
    ...
    assert_eq!(
        ...
        35,
        "Expected 35 IntegrationTest → Function edges"
    );
    ...
    assert_eq!(
        total_test_coverage_edges, 67,
        "Expected 67 total test coverage edges"
    );
...
async fn test_rust_graph_upload() -> Result<()> {
    ...
    assert_eq!(edges, 525, "Graph should have 525 edges after upload");
...
async fn test_nodes_class_type() -> Result<()> {
    ...
    assert_eq!(count, 17, "Should have 17 Class nodes");
...
async fn test_nodes_data_model_type() -> Result<()> {
    ...
    assert_eq!(count, 27, "Should have 27 DataModel nodes");
