...
async fn test_rust_coverage() -> Result<()> {
    ...
    assert_eq!(
        ...
        16,
        "Expected 16 IntegrationTest → Function edges"
    );
    ...
    assert_eq!(
        total_test_coverage_edges, 46,
        "Expected 46 total test coverage edges"
    );
...
async fn test_rust_graph_upload() -> Result<()> {
    ...
    assert_eq!(edges, 467, "Graph should have 467 edges after upload");
...
async fn test_coverage_default_params() -> Result<()> {
    ...
    assert_eq!(unit.total, 48, "Should have 48 unit test targets");
    ...
    assert_eq!(
        ...
        "Should have 48 integration test targets"
    );
    assert_eq!(
...
async fn test_coverage_with_ignore_dirs() -> Result<()> {
    ...
    assert_eq!(
        unit.total, 42,
        "Should have 42 targets after ignoring routes"
    );
...
async fn test_nodes_function_type() -> Result<()> {
    ...
    assert_eq!(count, 48, "Should have 48 unique Function nodes");
...
async fn test_nodes_endpoint_type() -> Result<()> {
    ...
    assert_eq!(count, 21, "Should have 21 Endpoint nodes");
...
async fn test_nodes_class_type() -> Result<()> {
    ...
    assert_eq!(count, 13, "Should have 13 Class nodes");
...
async fn test_nodes_trait_type() -> Result<()> {
    ...
    assert_eq!(count, 5, "Should have 5 Trait nodes");
...
async fn test_nodes_multi_type() -> Result<()> {
    ...
    assert_eq!(count, 69, "Should have 48 Functions + 21 Endpoints = 69");
...
async fn test_nodes_pagination_default() -> Result<()> {
    ...
    assert_eq!(count, 48, "Total count should be 48");
...
async fn test_nodes_pagination_large_offset() -> Result<()> {
    ...
    assert_eq!(count, 48, "Total count should still be accurate");
    assert!(
        results.is_empty(),
...
async fn test_nodes_pagination_max_limit() -> Result<()> {
    ...
    assert_eq!(count, 48, "Total count should be 48");
    assert_eq!(results.len(), 48, "Should return all 48 functions");
...
async fn test_nodes_repo_filter() -> Result<()> {
    ...
    assert_eq!(count, 48, "Should find 48 functions in Rust repo");
...
async fn test_nodes_is_muted() -> Result<()> {
    ...
    assert_eq!(unmuted_count, 48, "Unmuted count should be 48");
    assert_eq!(all_count, 48, "All count should be 48");
    assert_eq!(
